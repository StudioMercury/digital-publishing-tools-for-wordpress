...
if(!class_exists('DPSFolioAuthor_CMS_WP_Admin')) {

	class DPSFolioAuthor_CMS_WP_Admin extends DPSFolioAuthor_Module {
		...
		public static function dpsfa_settings_page(){
			$settingsService = DPSFolioAuthor_Settings::getInstance();
			$settingsService->settings_view();
            include_once( dirname( __DIR__ ) .'/views/dpsfa-settings.php');
		}
    ...
    } // END class DPSFolioAuthor_CMS_WP_Admin
}
