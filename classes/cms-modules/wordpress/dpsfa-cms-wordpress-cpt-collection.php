...
if(!class_exists('DPSFolioAuthor\CMS_Collection')) { 	
	class CMS_Collection {
		
		public $posttype;
		const NAME_SINGULAR = "Collection";
		const NAME_PLURAL = "Collections";
		
		public function __construct(){
			$this->posttype = DPSFA_PREFIX . strtolower(CMS_Collection::NAME_SINGULAR);
		}
		...
		public function createPostType(){
			...
			if( !post_type_exists( $this->posttype ) ){
				if(DPSFA_DEBUGMODE) log_message("CMS_Collection: Registering post type: " . $this->posttype); 
		...
		public function getPostTypeParams(){
			$labels = array(
				'name'					=> CMS_Collection::NAME_PLURAL,
				'singular_name'			=> CMS_Collection::NAME_SINGULAR,
				'menu_name'				=> CMS_Collection::NAME_PLURAL,
				'add_new'				=> 'Add New ' . CMS_Collection::NAME_SINGULAR,
				'add_new_item'			=> 'Add New '. CMS_Collection::NAME_SINGULAR,
				'edit'					=> 'Edit ' . CMS_Collection::NAME_PLURAL,
				'edit_item'				=> 'Edit '. CMS_Collection::NAME_SINGULAR,
				'new_item'				=> 'New '. CMS_Collection::NAME_SINGULAR,
				'view'					=> 'View '. CMS_Collection::NAME_PLURAL,
				'view_item'				=> 'View '. CMS_Collection::NAME_SINGULAR,
				'search_items'			=> 'Search '. CMS_Collection::NAME_PLURAL,
				'not_found'				=> 'No '. CMS_Collection::NAME_PLURAL . ' found',
				'not_found_in_trash'	=> 'No '. CMS_Collection::NAME_PLURAL . ' found in Trash',
				'parent'				=> 'Parent '. CMS_Collection::NAME_SINGULAR
			);

			$postTypeParams = array(
				'labels'				=> $labels,
				'description'			=> CMS_Collection::NAME_SINGULAR . ' post type for the ' . DPSFA_NAME . ' plugin',
				'show_ui' 				=> true,
				'singular_label'		=> CMS_Collection::NAME_SINGULAR,
				'public'				=> true,
